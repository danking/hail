...
object HailContext {
  ...
  def configureLogging(logFile: String, quiet: Boolean, append: Boolean, skipLoggingConfiguration: Boolean) {
    if (!skipLoggingConfiguration) {
      ...
      logProps.put("log4j.appender.AlwaysOnConsoleAppender.layout", "org.apache.log4j.JsonLayout")
      logProps.put("log4j.appender.AlwaysOnConsoleAppender.layout.compact", "true")
      logProps.put("log4j.appender.AlwaysOnConsoleAppender.layout.eventEol", "true")
      logProps.put("log4j.appender.AlwaysOnConsoleAppender.layout.complete", "true")
      logProps.put("log4j.appender.AlwaysOnConsoleAppender.layout.properties", "false")
      logProps.put("log4j.appender.AlwaysOnConsoleAppender.layout.propertiesAsList", "false")
      logProps.put("log4j.appender.AlwaysOnConsoleAppender.layout.locationInfo", "true")
      logProps.put("log4j.appender.AlwaysOnConsoleAppender.layout.includeNullDelimiter", "false")
      logProps.put("log4j.appender.AlwaysOnConsoleAppender.layout.objectMessageAsJsonObject", "true")
